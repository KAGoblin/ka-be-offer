"""
Django settings for ka_be_offer project.
...
WSGI_APPLICATION = 'ka_be_offer.wsgi.application'
...
# DEFAULT_TABLESPACE = 'ka_be_offer'
...
REST_FRAMEWORK = {
    ...
    # 'EXCEPTION_HANDLER': 'ka_be_offer.api.utils.exceptions.custom_exception_handler',
    # 'DEFAULT_PAGINATION_CLASS': 'ka_be_offer.api.framework.pagination.CustomPagination',
    # 'PAGE_SIZE': 10,
    'MAX_PAGE_SIZE': 1500,
